...
Again, the main reference is the RISC-V [**instruction set manual**](https://github.com/riscv/riscv-isa-manual), on which the README provides a link to the latest typeset specification of unprivileged instructions. Section 30 is on the V extension. Appendix C provides multiple example V extension programs.
...
The latest designs with throughput of 16 64-bit numbers (16 x 64 = 1024 bits), already run at below 1 Watt [Vitruvius+, Barcelona Supercomputing Centre](https://dl.acm.org/doi/full/10.1145/3575861). A complete ARM64 or Apple's M microprocessor usually runs at 5 Watts at load. The throughput of [Graviton 3 or 4](https://en.wikipedia.org/wiki/AWS_Graviton), ARM64 processor designed by Amazon, is 16 32-bit numbers (16 x 32 = 4 x 128 = 512), or 512 bits per clock cycle for the SVE (Scalable Vector Extension).
...
RISC-V announces ratification of the RVA23 profile standard, October 2024, [https://riscv.org/blog/risc-v-announces-ratification-of-the-rva23-profile-standard/](https://riscv.org/blog/risc-v-announces-ratification-of-the-rva23-profile-standard/)

RVA23 profiles, [https://github.com/riscv/riscv-profiles/blob/main/src/rva23-profile.adoc](https://github.com/riscv/riscv-profiles/blob/main/src/rva23-profile.adoc)

ARM64 SVE (Scalable Vector Extension), [/2025/10/15/sve.html](/2025/10/15/sve.html)

PULP (Parallel Ultra Low Power) Platform, [https://www.pulp-platform.org/](https://www.pulp-platform.org/)

PULP (Parallel Ultra Low Power) training, [https://www.pulp-platform.org/pulp_training.html](https://www.pulp-platform.org/pulp_training.html)

PULP (Parallel Ultra Low Power) conference and workshop materials, [https://www.pulp-platform.org/conferences.html](https://www.pulp-platform.org/conferences.html)

..., on which for example "Understanding performance numbers in Integrated Circuit Design" was an excellent exposition.

PULP (Parallel Ultra Low Power) 10-year conference, [https://pulp-platform.org/10years/](https://pulp-platform.org/10years/)
...
AraXL: A Physically Scalable, Ultra-Wide RISC-V Vector Processor Design for Fast and Efficient Computation on Long Vectors, [https://arxiv.org/abs/2501.10301](https://arxiv.org/abs/2501.10301)

AWS Graviton, ARM64 processor designed by Amazon with support for the SVE (Scalable Vector Extension), [https://en.wikipedia.org/wiki/AWS_Graviton](https://en.wikipedia.org/wiki/AWS_Graviton)
