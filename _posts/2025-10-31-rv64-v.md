...
The latest designs with throughput of 80 32-bit numbers (80 x 32 = 2560 bits), already run at below 1 Watt [Vitruvius+, Barcelona Supercomputing Centre]. Compare that with ARM64 or Apple's M microprocessors which usually run at 5 Watts at load. Graviton 3 or 4's throughput was 512 bits per clock cycle implementing ARM64 SVE (Scalable Vector Extension).
