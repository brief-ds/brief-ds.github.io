...
How does it calculate any item in the above polynomial? <math><mo>x</mo></math> would be a fractional number. The programmer has to remember the decimal point is before the fractional part. The fractional part is stored as one or more 15-bit integers.
