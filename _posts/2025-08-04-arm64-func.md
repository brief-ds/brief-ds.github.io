...
In the case of function calls, in any parent function, the link register lr storing return address along with the frame pointer fp must also be preserved.
