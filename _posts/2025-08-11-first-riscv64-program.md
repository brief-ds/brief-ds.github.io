...
The main reference is the **instruction set manual** at [https://github.com/riscv/riscv-isa-manual](https://github.com/riscv/riscv-isa-manual), whose README links to the documentation.
